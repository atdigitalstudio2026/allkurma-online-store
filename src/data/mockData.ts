...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    sku: 'AK-MDJ-500',
    barcode: '8997234560012',
    category: 'Medjool',
    description: 'Kurma Medjool pilihan grade A kualitas ekspor langsung dari perkebunan Jericho / Jordan Valley. Memiliki daging buah super tebal, lembut, manis karamel alami, kaya serat dan mineral tinggi.',
    images: [
    ...
    warehouseRack: 'Rak A-01 / Cold Storage #1',
    weightGram: 500,
    dimensionsCm: '20 x 12 x 5',
    harvestYear: 'Panen 2025/2026 (Fresh Import)',
    shelfLife: '24 Bulan',
    expiryDate: '2027-09-30',
    storageCondition: 'Simpan Dingin (Chiller 0°C - 5°C)',
    packagingType: 'Sealed Food Grade Box + Inner Foil',
    certification: 'Halal MUI & Karantina Kementan RI',
    isFlashSale: true,
    flashSaleDiscountPercent: 14,
    rating: 4.9,
    reviewCount: 1240,
    soldCount: 5420,
    origin: 'Jericho, Palestina',
    badge: 'PREMIUM GRADE',
    ...
    variations: [
      { id: 'v-mdj-250', name: 'Kemasan 250g Pouch', weightGram: 250, regularPrice: 95000, discountPrice: 80000, costPrice: 52000, stock: 120, minStockAlert: 15, sku: 'AK-MDJ-250', barcode: '8997234560011', packagingType: 'Standing Pouch Ziplock', warehouseRack: 'Rak A-01-A' },
      { id: 'v-mdj-500', name: 'Kemasan 500g VIP Box', weightGram: 500, regularPrice: 175000, discountPrice: 150000, costPrice: 98000, stock: 245, minStockAlert: 20, sku: 'AK-MDJ-500', barcode: '8997234560012', packagingType: 'Hardbox Segel Foil', warehouseRack: 'Rak A-01-B' },
      { id: 'v-mdj-1000', name: 'Kemasan 1kg Box Eksklusif', weightGram: 1000, regularPrice: 320000, discountPrice: 285000, costPrice: 185000, stock: 95, minStockAlert: 10, sku: 'AK-MDJ-1000', barcode: '8997234560013', packagingType: 'Exclusive Gift Box', warehouseRack: 'Rak A-01-C' },
      { id: 'v-mdj-5000', name: 'Karton Grosir 5kg Master', weightGram: 5000, regularPrice: 1450000, discountPrice: 1250000, costPrice: 820000, stock: 35, minStockAlert: 5, sku: 'AK-MDJ-5KG', barcode: '8997234560014', packagingType: 'Master Carton 5kg', warehouseRack: 'Palet B-01' }
    ]
  },
  {
    id: 'prod-02',
    ...
    sku: 'AK-AJW-001',
    barcode: '8997234560021',
    category: 'Ajwa',
    description: 'Kurma Ajwa Asli Madinah Al-Munawwarah dengan sertifikasi keaslian sanad perkebunan Madinah. Tekstur kenyal pas, warna hitam pekat bergaris halus, kaya khasiat dan penuh berkah.',
    images: [
      'https://images.unsplash.com/photo-1608755728617-aefab37d2edd?w=600&auto=format&fit=crop&q=80',
      'https://images.unsplash.com/photo-1596797882870-8c33deeac224?w=600&auto=format&fit=crop&q=80'
    ],
    ...
    minStockAlert: 30,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Rak A-02 / Suhu Sejuk',
    weightGram: 500,
    dimensionsCm: '18 x 12 x 5',
    harvestYear: 'Panen Musim 2025/2026',
    shelfLife: '24 Bulan',
    expiryDate: '2027-11-15',
    storageCondition: 'Suhu Sejuk Kering (< 20°C)',
    packagingType: 'Premium Embossed Box Madinah',
    certification: 'Halal Certified & Karantina Kementan RI',
    isFlashSale: true,
    ...
    variations: [
      { id: 'v-ajw-250', name: 'Kemasan 250g Jar', weightGram: 250, regularPrice: 80000, discountPrice: 69000, costPrice: 42000, stock: 150, minStockAlert: 20, sku: 'AK-AJW-250', barcode: '8997234560020', packagingType: 'Food Grade Jar', warehouseRack: 'Rak A-02-A' },
      { id: 'v-ajw-500', name: 'Kemasan 500g Madinah', weightGram: 500, regularPrice: 145000, discountPrice: 125000, costPrice: 80000, stock: 310, minStockAlert: 30, sku: 'AK-AJW-001', barcode: '8997234560021', packagingType: 'Box Madinah 500g', warehouseRack: 'Rak A-02-B' },
      { id: 'v-ajw-1000', name: 'Kemasan 1kg Hardbox VIP', weightGram: 1000, regularPrice: 280000, discountPrice: 240000, costPrice: 155000, stock: 80, minStockAlert: 10, sku: 'AK-AJW-1000', barcode: '8997234560022', packagingType: 'VIP Hardbox 1kg', warehouseRack: 'Rak A-02-C' }
    ]
  },
  {
    id: 'prod-03',
    ...
    minStockAlert: 15,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Rak A-03 / Cold Room',
    weightGram: 1000,
    dimensionsCm: '25 x 18 x 7',
    harvestYear: 'Panen 2025/2026',
    shelfLife: '24 Bulan',
    expiryDate: '2027-10-20',
    storageCondition: 'Chiller (0°C - 4°C)',
    packagingType: 'Luxury Hardbox Magnetic',
    certification: 'Halal MUI & Karantina Kementan RI',
    rating: 4.8,
    reviewCount: 450,
    soldCount: 1890,
    ...
    variations: [
      { id: 'v-jmb-1kg', name: 'Kotak 1kg Jumbo', weightGram: 1000, regularPrice: 240000, discountPrice: 210000, costPrice: 140000, stock: 85, minStockAlert: 15, sku: 'MDJ-JMB-1KG', barcode: '8997234560031', packagingType: 'Box Jumbo 1kg', warehouseRack: 'Rak A-03-A' },
      { id: 'v-jmb-3kg', name: 'Ember 3kg Jumbo Family', weightGram: 3000, regularPrice: 690000, discountPrice: 599000, costPrice: 400000, stock: 30, minStockAlert: 5, sku: 'MDJ-JMB-3KG', barcode: '8997234560032', packagingType: 'Bucket 3kg Food Safe', warehouseRack: 'Palet B-02' }
    ]
  },
  {
    id: 'prod-04',
    ...
    warehouseRack: 'Cold Room - Rak C-01 (Frozen/Chilled)',
    weightGram: 850,
    dimensionsCm: '16 x 16 x 8',
    harvestYear: 'Panen Segar Musim 2026',
    shelfLife: '12 Bulan (Beku/Dingin)',
    expiryDate: '2027-04-15',
    storageCondition: 'Wajib Beku/Dingin (-5°C s/d 4°C)',
    packagingType: 'Ember Segel Kedap Udara',
    certification: 'Halal Certified & Karantina Kementan RI',
    isFlashSale: true,
    ...
    variations: [
      { id: 'v-suk-500', name: 'Ember Kecil 500g', weightGram: 500, regularPrice: 65000, discountPrice: 55000, costPrice: 35000, stock: 200, minStockAlert: 25, sku: 'AK-SUK-500', barcode: '8997234560040', packagingType: 'Ember 500g', warehouseRack: 'Cold Room C-01-A' },
      { id: 'v-suk-850', name: 'Ember Standar 850g', weightGram: 850, regularPrice: 95000, discountPrice: 85000, costPrice: 55000, stock: 420, minStockAlert: 50, sku: 'AK-SUK-002', barcode: '8997234560041', packagingType: 'Ember 850g Segel', warehouseRack: 'Cold Room C-01-B' },
      { id: 'v-suk-3000', name: 'Ember Jumbo 3kg', weightGram: 3000, regularPrice: 285000, discountPrice: 245000, costPrice: 165000, stock: 65, minStockAlert: 10, sku: 'AK-SUK-3KG', barcode: '8997234560042', packagingType: 'Ember Jumbo 3kg', warehouseRack: 'Cold Room C-01-C' }
    ]
  },
  {
    id: 'prod-05',
    ...
    minStockAlert: 60,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Rak B-02 / Kering',
    weightGram: 500,
    dimensionsCm: '18 x 12 x 5',
    harvestYear: 'Panen 2025/2026',
    shelfLife: '18 Bulan',
    expiryDate: '2027-07-31',
    storageCondition: 'Suhu Ruang Sejuk (< 24°C)',
  ...
  },
  {
    ...
    minStockAlert: 25,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Rak D-01 / Ambient Kering',
    weightGram: 500,
    dimensionsCm: '10 x 10 x 18',
    harvestYear: 'Panen Hutan 2026',
    shelfLife: '36 Bulan',
    expiryDate: '2029-01-01',
    storageCondition: 'Suhu Ruang (Hindari Panas Matahari)',
    packagingType: 'Botol Kaca Hexagonal + Seal Cap',
    certification: 'BPOM RI & Halal MUI',
    rating: 4.9,
    reviewCount: 520,
    soldCount: 1650,
  ...
  },
  {
    ...
    minStockAlert: 35,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Rak B-01 / Kering',
    weightGram: 500,
    dimensionsCm: '20 x 14 x 5',
    harvestYear: 'Panen 2025/2026',
    shelfLife: '18 Bulan',
    expiryDate: '2027-08-30',
    storageCondition: 'Suhu Ruang Sejuk / Chiller',
    packagingType: 'Kotak Jendela Transparan Eksklusif',
    certification: 'Halal Certified & Karantina Kementan RI',
    rating: 4.8,
    reviewCount: 390,
    soldCount: 1450,
    origin: 'Nefta, Tunisia',
    badge: 'CRISPY SWEET'
  },
  {
    id: 'prod-08',
    ...
    minStockAlert: 100,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Palet C-03 / Cold Ambient',
    weightGram: 1000,
    dimensionsCm: '20 x 20 x 10',
    harvestYear: 'Batch Industri 2026',
    shelfLife: '24 Bulan',
    expiryDate: '2028-02-28',
    storageCondition: 'Suhu Sejuk Kering (< 20°C)',
    packagingType: 'Vacuum Block 1kg Food Grade',
    certification: 'BPOM RI & Halal MUI',
    rating: 4.9,
    reviewCount: 110,
    soldCount: 5200,
  ...
  },
  {
    ...
    minStockAlert: 10,
    warehouseLocation: 'Gudang Utama - Jakarta Pusat',
    warehouseRack: 'Area Assembly Hampers / Rak E-01',
    weightGram: 2500,
    dimensionsCm: '35 x 25 x 15',
    harvestYear: 'Koleksi Edisi Spesial 2026',
    shelfLife: '12 Bulan',
    expiryDate: '2027-03-31',
    storageCondition: 'Suhu Ruang Sejuk',
    packagingType: 'Wooden Gift Box + Pita Emas',
